...
void analysis_3()
{
 ...
 //Fitting
 TF1 *fSignal2 = new TF1("fSignal","gaus",0.47 , 0.52);
 TF1 *fBackground2 = new TF1("fBackground","pol3",0.475 , 0.52);
 TF1 *fSpectrum2 = new TF1("fSpectrum","gaus+pol3(3)",0.475, 0.52);

 fSpectrum2->SetParameters(2200, 0.5, 0.005, 2200, 0, 0, 0);
 m_3pi->Fit("fSpectrum2", "", "", 0.475, 0.52);
 Double_t param2[7];
